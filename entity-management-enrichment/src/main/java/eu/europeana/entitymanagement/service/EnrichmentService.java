...
@Service(EnrichmentConstants.BEAN_ENTITY_ENRICHMENT_SERVICE)
public class EnrichmentService {
    ...
    public void saveEnrichment(EntityRecord entityRecord) {
        try {
            ...
            Optional<EnrichmentTerm> existingEnrichment = enrichmentDao.getEnrichmentTermByField(EnrichmentConstants.ENRICHMENT_ABOUT,
