...
/**
 * Mongo generates a hexadecimal value by default for ObjectIds
 * This class (and its corresponding Mongo collection) help to generate auto-incremented numerical values instead.
 */
