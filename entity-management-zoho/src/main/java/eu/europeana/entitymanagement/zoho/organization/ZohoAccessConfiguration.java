...
public class ZohoAccessConfiguration {
    ...
    public ZohoAccessClient getZohoAccessClient() throws Exception {
        ...
        zohoAccessClient = new ZohoAccessClient(
                getFileTokenStore(),
                zohoEmail,
                zohoClientId,
                zohoClientSecret,
        ...
        if (!StringUtils.isBlank(zohoRefreshToken)) {
            ...
            OAuthToken refreshToken = new OAuthToken(zohoClientId, zohoClientSecret, zohoRefreshToken,
                    TokenType.REFRESH, zohoRedirectUrl);
