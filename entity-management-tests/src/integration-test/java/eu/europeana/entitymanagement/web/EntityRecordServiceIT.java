...
public class EntityRecordServiceIT extends AbstractIntegrationTest {
  ...
  public void mergeEntities() throws Exception {
    ...
    XmlConceptImpl xmlEntity =
        (XmlConceptImpl) getMetisResponse(IntegrationTestUtils.CONCEPT_DATA_RECONCELIATION_XML);
  ...
  public void mergeEntitiesBathtub() throws Exception {
     ...
     */
    XmlConceptImpl xmlEntity =
        (XmlConceptImpl) getMetisResponse(IntegrationTestUtils.CONCEPT_BATHTUB_XML);
    ...
    Concept concept_consolidated =
        objectMapper.readValue(
            IntegrationTestUtils.loadFile(IntegrationTestUtils.CONCEPT_CONSOLIDATED_BATHTUB),
            Concept.class);
  ...
  public void schemaorgTestProperties() throws Exception {
    XmlAgentImpl xmlEntity =
        (XmlAgentImpl) getMetisResponse(IntegrationTestUtils.AGENT_DA_VINCI_XML);
    Agent agentExternalEntity = xmlEntity.toEntityModel();
    Agent agentInternalEntity =
        objectMapper.readValue(
            IntegrationTestUtils.loadFile(IntegrationTestUtils.AGENT_REGISTER_DAVINCI_JSON),
            Agent.class);
