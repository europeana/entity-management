...
/**
 * Instantiates a {@link eu.europeana.entitymanagement.definitions.model.impl.EntityImpl} instance, based on
 * the {@link eu.europeana.entitymanagement.web.xml.model.XmlBaseEntityImpl} instance
 */
public class BaseEntityFactory {

    public static EntityImpl createEntityFromXmlType(Class<? extends EntityImpl> xmlBaseEntityClass) throws EntityCreationException {
