...
public class RequestPathMethodService implements InitializingBean {
    ...
    /**
     * Map request urls to Http request methods (implemented across the application) with the url pattern.
     */
    ...
    /**
     * Gets request methods that are implemented across the application for this request's URL pattern.
     * The return value from this method is used when setting the Allow header in API responses.
     * @param request {@link HttpServletRequest} instance
     * @return Optional containing matching request methods, or empty optional if no match could be determined.
     */
