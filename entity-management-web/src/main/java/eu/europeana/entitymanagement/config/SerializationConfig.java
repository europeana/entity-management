...
public class SerializationConfig {
  ...
  public JAXBContext jaxbContext() throws JAXBException {
    // args are wrapper classes for Deserializing Metis Response, Wikidata response, and Serializing
    // XML output
    return JAXBContext.newInstance(
        EnrichmentResultList.class, RdfBaseWrapper.class, WikidataOrganization.class);
  }
