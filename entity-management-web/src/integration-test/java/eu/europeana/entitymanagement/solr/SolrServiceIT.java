...
public class SolrServiceIT extends AbstractIntegrationTest {
    ...
    EntityRecord buildAgentRecord() throws JsonProcessingException, JsonMappingException, IOException {
    ...
    public void searchAgentInEuropeana() throws Exception {
        ...
        List<SolrEntity<Entity>> agents = emSolrService.search(query);
    ...
    public void storeOrganizationInSolr() throws Exception {
        ...
        emSolrService.storeEntity(SolrUtils.createSolrEntity(record));
        SolrOrganization storedOrganization = emSolrService.searchById(SolrOrganization.class,
    ...
    void shouldSearchByQuery() throws Exception {
        ...
        List<SolrEntity<? extends Entity>> solrEntities = List.of(agentRecord, placeRecord, conceptRecord).stream()
                .map(SolrUtils::createSolrEntity).collect(Collectors.toList());
