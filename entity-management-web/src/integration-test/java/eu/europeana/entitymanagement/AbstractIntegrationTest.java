...
public abstract class AbstractIntegrationTest {
   ...
   *
   * <p>Since the WebServer is reused across tests, every test interacting with Metis NEEDS to call
   * assertMetisRequest() to clear its queue!
   *
   * <p>See: https://github.com/spring-projects/spring-framework/issues/24825
   */
