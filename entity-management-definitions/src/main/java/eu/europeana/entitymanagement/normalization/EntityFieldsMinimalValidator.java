...
@Component
public class EntityFieldsMinimalValidator
    implements ConstraintValidator<EntityFieldsMinimalValidatorInterface, Entity> {
      ...
      for (Field field : entityFields) {
        ...
        if (minContentCount > 0) {
          if ((List.class.isAssignableFrom(fieldValue.getClass())
            ...
            addConstraint(
                context, fieldName + " must have at least " + minContentCount + " values");
            isValid = false;
          }
        }
      }
