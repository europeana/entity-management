...
public interface AgentSolrFields extends EntitySolrFields{
	...
	public static final String BIOGRAPHICAL_INFORMATION_ALL = "rdagr2_biographicalInformation"+ DYNAMIC_FIELD_SEPARATOR + "*"; 
	public static final String DATE_OF_BIRTH_ALL            = "rdagr2_dateOfBirth"+ DYNAMIC_FIELD_SEPARATOR + "*";
	public static final String DATE_OF_DEATH_ALL            = "rdagr2_dateOfDeath"+ DYNAMIC_FIELD_SEPARATOR + "*";
	...
	public static final String PLACE_OF_BIRTH_ALL       = "rdagr2_placeOfBirth"+ DYNAMIC_FIELD_SEPARATOR + "*";
	public static final String PLACE_OF_DEATH_ALL       = "rdagr2_placeOfDeath"+ DYNAMIC_FIELD_SEPARATOR + "*";
	...
	public static final String PROFESSION_OR_OCCUPATION_ALL = "rdagr2_professionOrOccupation"+ DYNAMIC_FIELD_SEPARATOR + "*";
