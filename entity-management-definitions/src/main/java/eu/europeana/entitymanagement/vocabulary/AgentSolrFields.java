...
public interface AgentSolrFields extends EntitySolrFields {
  ...
  public static final String PLACE_OF_BIRTH_ALL =
          PLACE_OF_BIRTH + DYNAMIC_FIELD_SEPARATOR + "*";
  public static final String PLACE_OF_DEATH_ALL =
          PLACE_OF_DEATH + DYNAMIC_FIELD_SEPARATOR + "*";
  ...
  public static final String DATE_OF_ESTABLISHMENT_ALL = "rdagr2_dateOfEstablishment" + DYNAMIC_FIELD_SEPARATOR + "*";
  public static final String DATE_OF_TERMINATION_ALL = "rdagr2_dateOfTermination" + DYNAMIC_FIELD_SEPARATOR + "*";
