...
import eu.europeana.entitymanagement.common.exception.DatasourceNotReachableException;
import eu.europeana.entitymanagement.common.exception.DatasourceUpstreamServerError;
...
public class MetisDereferenceService implements InitializingBean, Dereferencer {
  ...
  public Optional<Entity> dereferenceEntityById(String id) throws Exception {
    ...
    XmlBaseEntityImpl<?> metisResponse =
        MetisDereferenceUtils.parseMetisResponse(unmarshaller.get(), id, metisResponseBody);
