...
public class AppConfigConstants {
  ...
  public static final String BEAN_BATCH_SCHEDULED_TASK_SERVICE = "batchScheduledTaskService";
  public static final String BEAN_FAILED_TASK_SERVICE = "failedTaskService";
