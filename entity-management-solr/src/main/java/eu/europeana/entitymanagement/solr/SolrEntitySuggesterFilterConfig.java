...
public class SolrEntitySuggesterFilterConfig {
    ...
    public FilterProvider solrEntitySuggesterFilter() {
        ...
        filterProvider.addFilter(SOLR_AGENT_SUGGESTER_FILTER, 
        		SimpleBeanPropertyFilter.filterOutAllExcept("id", "type", "isShownBy", "prefLabel", "altLabel", "hiddenLabel", "dateOfBirth", "dateOfDeath", "dateOfEstablishment", "dateOfTermination"));
        filterProvider.addFilter(SOLR_ORGANIZATION_SUGGESTER_FILTER, 
        		SimpleBeanPropertyFilter.filterOutAllExcept("id", "type", "isShownBy", "prefLabel", "altLabel", "hiddenLabel", "acronym", "organizationDomain", "country"));
        filterProvider.addFilter(SOLR_TIMESPAN_SUGGESTER_FILTER, 
        		SimpleBeanPropertyFilter.filterOutAllExcept("id", "type", "isShownBy", "prefLabel", "altLabel", "hiddenLabel", "begin", "end"));
